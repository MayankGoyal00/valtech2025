...
public class QuestionController {
	...
	@PutMapping("/{id}")
	public QuestionVO updateQuestion(@RequestBody QuestionVO questionVO, @PathVariable("id") long id) {
	...
	public List<Long> getQuestionsForQuiz(@RequestParam String topicName, @RequestParam Long numQuestions) {
	    return questionService.getQuestionForQuiz(topicName, numQuestions);
	}
